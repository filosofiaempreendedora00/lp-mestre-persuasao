  ...
  return (
    <section className="section bg-section-dark-2">
      <div className="container-lp max-w-2xl mx-auto text-center">
        ...
        <a href="https://api.whatsapp.com/send?phone=5527998001953" className="btn-whatsapp inline-flex" target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp">
